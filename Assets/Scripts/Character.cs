...
public class Character : MonoBehaviour
{
    ...
    private void ShootAutoAim()
    {
        ...
        float closestDistance = 1000; // juste une grande valeur forc�ment trop grande
        ...
        if (enemy != null)
        {
            ...
            float horizontalBoss = Mathf.Sqrt(Mathf.Pow(enemy.transform.position.x - gameObject.transform.position.x, 2) /* Ce truc est �gale �Ez�ro, on s'en fou + Mathf.Pow(ennemy.transform.position.y - ennemy.transform.position.y, 2) */);
